...
export default function Hero() {
  return (
    <section className="relative container mx-auto flex flex-col justify-center border-b border-dashed border-primary px-2 py-16 lg:flex-row lg:justify-between">
      ...
      <div className="z-1 mx-auto text-center">
        ...
        <p className="mx-auto max-w-3xl text-xl text-muted-foreground">
          ...
          , and let <span className="font-medium">CRAFTER 2.0</span> generate a
          structured <span className="font-medium">persona</span> for your
          research needs.
        </p>
      </div>
    </section>
