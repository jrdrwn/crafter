  ...
  return (
    <section className="relative border-b border-dashed border-primary px-2 py-8 md:py-12 lg:py-16">
      <div className="container mx-auto flex flex-col justify-center lg:flex-row lg:justify-between">
        ...
        <div className="z-1 mx-6 flex w-full flex-col items-start gap-4 sm:mx-10 sm:gap-6 md:flex-row md:items-center md:justify-between lg:mx-14">
          ...
          <div className="w-full md:w-auto">
            <Link href={'/create'} className="block w-full md:w-auto">
