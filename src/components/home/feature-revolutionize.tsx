...
export default function FeatureRevolutionize() {
  return (
    <section className="relative container mx-auto px-24 py-14">
      ...
      <div>
        ...
        <p className="max-w-3xl text-lg">
          With a taxonomy-based methodology, CRAFTER 2.0 generates personas that
          are not only accurate, but also consistent and reliable for a wide
          range of user research needs.
        </p>
      </div>
      <div className="mt-8">
