...
describe('RootLayout', () => {
  ...
  // Note: Testing html/body attributes is skipped because RootLayout renders
  // <html> and <body> elements which cannot be tested with jsdom's container.
  // These tests would require a real browser environment.
});
